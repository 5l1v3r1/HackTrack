...
RSpec.describe "otg_sesses/new", type: :view do
  before(:each) do
    assign(:otg_sess, OtgSess.new(
      :target_id => 1,
      :one_id => "MyString",
  ...
  it "renders new otg_sess form" do
    render

    assert_select "form[action=?][method=?]", otg_sesses_path, "post" do

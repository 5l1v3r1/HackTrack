...
RSpec.describe "otg_buslogics/new", type: :view do
  before(:each) do
    assign(:otg_buslogic, OtgBuslogic.new(
      :target_id => 1,
      :one_id => "MyString",
  ...
  it "renders new otg_buslogic form" do
    render

    assert_select "form[action=?][method=?]", otg_buslogics_path, "post" do

...
RSpec.describe "otg_idents/edit", type: :view do
  before(:each) do
    @otg_ident = assign(:otg_ident, OtgIdent.create!(
      :target_id => 1,
      :one_id => "MyString",
  ...
  it "renders the edit otg_ident form" do
    render

    assert_select "form[action=?][method=?]", otg_ident_path(@otg_ident), "post" do

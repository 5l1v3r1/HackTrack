...
RSpec.describe "otg_infos/new", type: :view do
  before(:each) do
    assign(:otg_info, OtgInfo.new(
      :target_id => 1,
      :one_id => "MyString",
  ...
  it "renders new otg_info form" do
    render

    assert_select "form[action=?][method=?]", otg_infos_path, "post" do

...
RSpec.describe "otg_authns/edit", type: :view do
  before(:each) do
    @otg_authn = assign(:otg_authn, OtgAuthn.create!(
      :target_id => 1,
      :one_id => "MyString",
  ...
  it "renders the edit otg_authn form" do
    render

    assert_select "form[action=?][method=?]", otg_authn_path(@otg_authn), "post" do

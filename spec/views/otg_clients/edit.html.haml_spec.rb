...
RSpec.describe "otg_clients/edit", type: :view do
  before(:each) do
    @otg_client = assign(:otg_client, OtgClient.create!(
      :target_id => 1,
      :one_id => "MyString",
  ...
  it "renders the edit otg_client form" do
    render

    assert_select "form[action=?][method=?]", otg_client_path(@otg_client), "post" do
